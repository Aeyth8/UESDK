...
public:
    ...
    // New in 5.3?
    virtual std::optional<size_t> GetARCompositionComponent_index() const { return std::nullopt;  }
    virtual std::optional<size_t> GetARCompositionComponent_2_index() const { return std::nullopt;  }
...
public:
    ...
    std::optional<size_t> GetARCompositionComponent_index() const override { return 39; }
    std::optional<size_t> GetARCompositionComponent_2_index() const override { return 40; }
    std::optional<size_t> GetLoadingScreen_index() const override { return 41; }
    std::optional<size_t> IsHeadTrackingAllowed_index() const override { return 42; }
    std::optional<size_t> IsHeadTrackingAllowedForWorld_index() const override { return 43; }
    std::optional<size_t> IsHeadTrackingEnforced_index() const override { return 44; }
    std::optional<size_t> SetHeadTrackingEnforced_index() const override { return 45; }
    std::optional<size_t> OnBeginPlay_index() const override { return 46; }
    std::optional<size_t> OnEndPlay_index() const override { return 47; }
    std::optional<size_t> OnStartGameFrame_index() const override { return 48; }
    std::optional<size_t> OnEndGameFrame_index() const override { return 49; }
    std::optional<size_t> OnBeginRendering_RenderThread_index() const override { return 50; }
    std::optional<size_t> OnBeginRendering_GameThread_index() const override { return 51; }
    std::optional<size_t> OnLateUpdateApplied_RenderThread_index() const override { return 52; }
    std::optional<size_t> GetHMDData_index() const override { return 53; }
    std::optional<size_t> GetMotionControllerData_index() const override { return 54; }
    std::optional<size_t> GetCurrentInteractionProfile_index() const override { return 55; }
    std::optional<size_t> ConfigureGestures_index() const override { return 56; }
    std::optional<size_t> ConnectRemoteXRDevice_index() const override { return 57; }
    std::optional<size_t> DisconnectRemoteXRDevice_index() const override { return 58; }
    std::optional<size_t> GetPlayAreaBounds_index() const override { return 59; }
    std::optional<size_t> GetTrackingOriginTransform_index() const override { return 60; }
    std::optional<size_t> GetPlayAreaRect_index() const override { return 61; }
};
}
